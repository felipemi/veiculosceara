            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('image-attachment'); ?>>
                <header class="entry-header">
                    ...
                    <footer class="entry-meta">
                        ...
                        ?>
                        <?php edit_post_link(__('Edit', 'cearaveiculos'), '<span class="edit-link">', '</span>'); ?>
                    </footer><!-- .entry-meta -->

                    <nav id="image-navigation" class="navigation" role="navigation">
                        <span class="previous-image"><?php previous_image_link(false, __('&larr; Previous', 'cearaveiculos')); ?></span>
                        <span class="next-image"><?php next_image_link(false, __('Next &rarr;', 'cearaveiculos')); ?></span>
...
// If there is more than 1 attachment in a gallery
                    ...
                    <div class="entry-description">
                        <?php the_content(); ?>
                        <?php wp_link_pages(array('before' => '<div class="page-links">' . __('Pages:', 'cearaveiculos'), 'after' => '</div>')); ?>
